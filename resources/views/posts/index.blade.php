...
@section('content')
    <div class="article-list-container">
                ...
                <div class="filter-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-input"
                            placeholder="عنوان مقاله را وارد کنید..." value="{{ request('title') }}">
                    </div>
        ...
        <!-- عنوان بخش لیست -->
        <div class="section-subtitle inline">
            <span class="title-accent"></span>
            <h4>لیست مقالات</h4>
        </div>
        @if (session('success'))
            <div class="alert alert-success d-inline-flex align-items-center gap-2 py-2 px-3 my-2" role="alert">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="action-buttons">
                                        <a href="{{ route('posts.edit', $post->id) }}" class="btn-action btn-edit"
                                            title="ویرایش">
                                            {{--  --}}
